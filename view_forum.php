	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-body">
				...
				<span class="badge badge-primary text-white ml-2"><i class="fa fa-comments"></i> <?php echo number_format(count($com_arr)) ?> Answer/s</span>
				</div>
		...
		<div class="card">
    		...
    		<div class="col-lg-12">
    			<div class="row">
    				<h3><b> <i class="fa fa-comments"></i> Answer/s</b></h3>
    			</div>

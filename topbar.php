...
<nav class="navbar navbar-light fixed-top bg-primary" style="padding:0;min-height: 3.5rem;background-color:red;">
  <div class="container-fluid mt-2 mb-2">
      ...
      <div class="col-md-4 float-left text-white">
        <large><b>Question and Answer Discussion Forum</b></large>
      </div>

		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="card">
					...
					<i class="fa fa-plus"></i> Ask a Qestion?</button>
				</span>
					</div>
					<div class="card-body">
						<ul class="w-100 list-group" id="topic-list">
							...
							<li class="list-group-item mb-4">
								...
								<span class="float-left badge badge-primary text-white ml-2"><i class="fa fa-comments"></i> <?php echo number_format($view) ?> Answer/s <?php echo $replies > 0 ? " and ".number_format($replies).' replies':'' ?> </span>
